...
class Online_Reg_Config_Class{
  ...
  var $c_EventName = "Your Event Name 2016";
  var $c_EventAbbrev = "Event2016";
  ...
  var $c_notify_url = "http://www.yourdomain.com/Event2016/olr-pp-ipn.php";
  var $c_return_url = "http://www.yourdomain.com/Event2016/online-reg.html";
  var $c_paypal_page_style = "";
  var $c_excel_filename = "OnlineRegs.csv";  // download from Print Regs page
  var $c_payment_email = "payments@yourdomain.com";  // "From" field for emails
  var $c_webmaster_email = "webmaster@yourdomain.com"; // Webmaster email
  ...
  var $c_dbhost = "yourhost";  // database host name
  var $c_dbname = "weblogin_onlinereg";  // database name
  var $c_dbusername = "weblogin_oruser1";  // user name
  var $c_dbpassword = "password";  // user password
  var $c_dbtable = "EVENT2016"; // database table name
